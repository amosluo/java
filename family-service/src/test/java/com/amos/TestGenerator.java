...
public class TestGenerator {
    ...
    void test(){
        ...
        globalConfig.setAuthor("amos")
                .setOutputDir("G:\\Case\\Java\\family-service\\src\\main\\java")//设置输出路径
        ...
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://192.168.3.121:3306/family_service_platform?serverTimezone=UTC")
        ...
        packageConfig.setParent("com.amos").setMapper("mapper")
